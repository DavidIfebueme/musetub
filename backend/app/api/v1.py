...
from app.features.contact.routes import router as contact_router
from app.features.content.routes import router as content_router
from app.features.creators.routes import router as creators_router
...
api_v1_router.include_router(contact_router, tags=["contact"])
...
api_v1_router.include_router(creators_router, tags=["creators"])
